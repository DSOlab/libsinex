...
///       "STAX " and "STAXfoobar".
inline bool parameter_type_exists_impl(const char *ptype, std::false_type) noexcept {
  auto it =
...
inline bool parameter_type_exists_impl(const char *ptype, std::true_type) noexcept {
  auto it = std::find_if(
